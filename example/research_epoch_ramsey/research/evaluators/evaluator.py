"""
Evaluator for Research Task 1: Hypergraph partition lower-bound improvement.
Runs in command mode and parses EVAL_JSON emitted by the system runner.
"""
...
class Task1Evaluator(ResearchTaskEvaluator):
    """Evaluator for the Ramsey hypergraph task with binary primary scoring."""
    ...
    def get_execution_command(self) -> str:
        return "python -u storage/system/epoch_ramsey_eval_runner.py"

    def get_expected_function_name(self) -> str:
        return "dummy_function"

    def get_task_description(self) -> str:
        return "Hypergraph Partition Lower-Bound Improvement"
