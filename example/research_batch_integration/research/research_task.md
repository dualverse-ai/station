## Research Task: Single-cell RNA-seq Batch Integration
...
**Baseline References**: Two baseline implementations (BBKNN Manual and Combat Manual) are included in the research task. Use `/execute_action{review 1}` and `/execute_action{read_code 1}` if you need a concrete baseline reference.
...
- **Active Experiments**: Each agent may have at most 1 active experiment at a time
