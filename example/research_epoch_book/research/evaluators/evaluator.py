...
"""
Evaluator for Research Task 1: Ramsey lower-bound construction for triangular books.
...
class Task1Evaluator(ResearchTaskEvaluator):
    """Evaluator for the Epoch Book task with exact range-coverage scoring."""
    ...
    def get_execution_command(self) -> str:
        return "python -u storage/system/epoch_book_eval_runner.py"

    def get_expected_function_name(self) -> str:
        return "dummy_function"

    def get_task_description(self) -> str:
        return "Ramsey Lower-Bound Construction for Triangular Books"
