## Research Task: Neural Activity Forecasting on ZAPBench
...
- `defaults.py`: Default implementations (use `/execute_action{read system/defaults.py}`)
...
- **No custom scripts**: Only override the provided function interface. Do not define your own training loop—doing so will be treated as hacking.
