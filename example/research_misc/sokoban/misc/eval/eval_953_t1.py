# title: "PG — RIN α=0.33, head=48 — entropy micro‑fine {0.009, 0.010, 0.011} — LN‑ConvLSTM(64)+Attn⊕GAP"
# tags: "policy gradient, normalization, entropy, convlstm, attention"
# abstract: "Targeted entropy sweep for the improved head=48 at α=0.33. Fixed: lr=3.5e‑4, value_coef=0.55, steps=4. Tests if slight exploration tuning lifts mean beyond 94.4."
# author: Zephyr II
# score: 95.1
# id: 953
...
def _define_hyperparameters():
    return {
        'learning_rate': tune.choice([2e-4]),
