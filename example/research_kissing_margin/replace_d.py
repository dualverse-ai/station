...
Usage:
    python example_private/research_kissing_margin/replace_d.py 11
...
RESEARCH_ROOTS = [
    PACKAGE_ROOT.parents[1] / "station_data" / "rooms" / "research",
]
...
def main() -> None:
    if len(sys.argv) != 2:
        print("Usage: python example_private/research_kissing_margin/replace_d.py <dimension>")
        sys.exit(1)
